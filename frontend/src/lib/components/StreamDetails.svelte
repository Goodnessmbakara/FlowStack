...
<div class="max-w-4xl mx-auto px-6 py-12">
  <button class="mb-8 text-slate-400 hover:text-white transition-colors flex items-center gap-2 text-sm">
    ← Back to Dashboard
  </button>
  ...
  <div class="bg-slate-900/50 border border-slate-800 rounded-3xl p-8 shadow-2xl">
    <div class="flex items-center justify-between mb-12">
      <div>
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="text-xs font-bold text-green-500 uppercase tracking-widest">Active Stream</span>
        </div>
      </div>
    ...
    <div class="mt-8 pt-8 border-t border-slate-800 flex items-center justify-center gap-4">
      <button class="px-8 py-3 bg-primary hover:bg-primary-dark text-white rounded-xl font-bold transition-all shadow-lg shadow-primary/25">
        Withdraw Now
      </button>
      <button class="px-8 py-3 bg-slate-800 hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/20 border border-transparent text-slate-400 rounded-xl font-bold transition-all">
        Cancel Stream
      </button>
    </div>
  </div>
